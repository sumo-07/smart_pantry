    ...
    <div className="relative isolate overflow-hidden bg-brand-dark min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12">
      ...
      >
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-gray-400">Log in to track your pantry inventories</p>
        </div>
        ...
        <div className="glass-panel rounded-3xl p-6 sm:p-8 space-y-6 border border-gray-800">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="login-email-input" className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2">
                Email Address
              </label>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label htmlFor="login-password-input" className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider">
                  Password
                </label>
              </div>
              <div className="relative">
